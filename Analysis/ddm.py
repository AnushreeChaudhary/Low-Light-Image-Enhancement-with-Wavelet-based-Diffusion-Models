...
class DenoisingDiffusion(object):
    ...
    def train(self, DATASET):
        ...
        for epoch in range(self.start_epoch, self.config.training.n_epochs):
            ...
            data_time = 0
            epoch_header = f"Epoch {epoch+1} logs:"
            step_logs.append(epoch_header)
            for i, (x, y) in enumerate(train_loader):
                ...
                if self.step % 10 == 0:
                    ...
                    log_entry = "step:{}, lr:{:.6f}, noise_loss:{:.4f}, photo_loss:{:.4f}, frequency_loss:{:.4f}".format(
                    self.step, 
            ...
            epoch_times.append(f"Epoch {epoch+1}: {epoch_duration:.2f} seconds")
        ...
        with open("epoch_times.txt", "w") as f:
